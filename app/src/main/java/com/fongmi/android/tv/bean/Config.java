...
public class Config {
    ...
    public static Config vod() {
        ...
        // Migrate installations that still hold the old placeholder asset config.
        if (item == null || TextUtils.equals(item.getUrl(), "assets://config.json")) return create(0, Constant.DEFAULT_VOD_CONFIG, "默认配置");
        return item;
    }
